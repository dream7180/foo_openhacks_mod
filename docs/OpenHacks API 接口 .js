...
function uiHacksSet() {
	...
	UIHacks.DisableSizing = false;	//禁止调整窗口大小
	UIHacks.EnableMinSize = true;  	//启用最小尺寸约束
	UIHacks.EnableMaxSize = true; 	//启用最大尺寸约束
	UIHacks.MinWidth = 1024;	//最小宽度 (像素) 请修改为你需要的值或变量
	UIHacks.MinHeight = 768;	//最小高度 (像素) 请修改为你需要的值或变量
	UIHacks.MaxWidth = 1920;	//最大宽度 (像素) 请修改为你需要的值或变量
	UIHacks.MaxHeight = 1080;	//最大高度 (像素) 请修改为你需要的值或变量
}
