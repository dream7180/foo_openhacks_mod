...
public:
    ...
    STDMETHOD(get_DisableSizing)(VARIANT_BOOL* pValue);
    STDMETHOD(put_DisableSizing)(VARIANT_BOOL value);

    STDMETHOD(get_EnableMinSize)(VARIANT_BOOL* pValue);
    STDMETHOD(put_EnableMinSize)(VARIANT_BOOL value);

    STDMETHOD(get_EnableMaxSize)(VARIANT_BOOL* pValue);
    STDMETHOD(put_EnableMaxSize)(VARIANT_BOOL value);

    STDMETHOD(get_MinWidth)(LONG* pValue);
    STDMETHOD(put_MinWidth)(LONG value);

    STDMETHOD(get_MinHeight)(LONG* pValue);
    STDMETHOD(put_MinHeight)(LONG value);

    STDMETHOD(get_MaxWidth)(LONG* pValue);
    STDMETHOD(put_MaxWidth)(LONG value);

    STDMETHOD(get_MaxHeight)(LONG* pValue);
    STDMETHOD(put_MaxHeight)(LONG value);
